...
\caption[Average brain connectome at 1 (a) and 2 (b) year old using the circle plotting ]{Average brain connectome at 1 (a) and 2 (b) year old using the circle plotting}
...
\caption[Average brain connectome at 1 (a) and 2 (b) year old on brain templates ]{Average brain connectome at 1 (a) and 2 (b) year old on brain templates }
\label{fig:AverageBrainConnectomeBrainTemplate}
\end{figure} 

First, we visualized that the shape of the connectivity is very similar at both ages. However some links are missing in the brain connectome for 1 year old subject. Moreover, the connectivity is lower for 1 year old children compare to 2 year children.
...
Deviation threshold : 0.2 0.05

Figure shows the variabilty 

\begin{figure}
\centering 
\subfigure[]{\includegraphics[width=8cm]{variance_1y.png}}
\subfigure[]{\includegraphics[width=8cm]{variance_2y.png}}
\caption[Variability of brain connectome at 1 (a) and 2 (a) year old using the circle plotting ]{Average brain connectome at 1 and 2 year old using the circle plotting }
...
\caption[Standard deviation of the brain connectome at 1 (a) and 2 (b) year old on brain templates ]{Standard deviation of the brain connectome at 1 (a) and 2 (b) year old on brain templates }
