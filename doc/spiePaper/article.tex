...
\caption[Average brain connectome at 1 (a) and 2 (b) year old]{Average brain connectome at 1 and 2 year old}
\label{fig:AverageBrainConnectome}
\end{figure} 

\begin{figure}
\centering 
\subfigure[]{\includegraphics[width=15cm]{average_brainTemplate_1y.png}}
\subfigure[]{\includegraphics[width=15cm]{average_brainTemplate_2y.png}}
\caption[Average brain connectome at 1 and 2 year old]{Average brain connectome at 1 and 2 year old}
...
\begin{figure}
\centering 
\subfigure[]{\includegraphics[width=15cm]{variance_1y.png}}
\subfigure[]{\includegraphics[width=15cm]{variance_2y.png}}
\caption[Variability of brain connectome at 1 and 2 year old]{Average brain connectome at 1 and 2 year old}
\label{fig:VariabilityBrainConnectome1YearOld}
\end{figure} 
